                ...
                children: [
                    SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        inputFormatters: [FilteringTextInputFormatter.allow(RegExp('[0-9]'))], //숫자만 입력 가능
                      ),
                    ),
                  Sbox(10, 0),
                  Image.asset("images/point.png", width:25, height: 25,),
                ],
              ),
              Sbox(0, 20),
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    focusedBorder: OutlineInputBorder(
                      borderSide: BorderSide(color: maincolor),), //선택했을 때 색 파랗게 해봄...
                    ),
                  ),
                ),
              Sbox(0, 20),
